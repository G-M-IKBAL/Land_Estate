...
const Calendar = () => {
  ...
  useEffect(() => {
    const dataFetch = async () => {
      const res = await fetch('http://localhost:8080/admin/getAppointments', {
        method: "POST",
        headers: {
      ...
      <Box display="flex" justifyContent="space-between">
        ...
        >
          ...
          <Box sx={{
            ...
            <LocalizationProvider dateAdapter={AdapterDateFns}>
              <DatePicker
                ...
                renderInput={(params) => <TextField {...params}
                  label="Date"
                  sx={{ gridColumn: "span 3" , width:"8.7cm",mt:"15%",ml:"0%"}}
                  variant="filled"
                  value={eDate}
                  name="date"
                />
            ...
            <Box display="flex"  mt="30px"  alignItems="center" ml="40%">
